...
@section('content')
    ...
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class="fa fa-edit"></i>Add New Income</h1>
            </div>
        ...
        <div class="">
            <a class="btn btn-primary" href="{{route('income.index')}}"><i class="fa fa-edit"></i> Manage Income</a>
            <a class="btn btn-primary" href="{{route('incomeitem.getitem')}}"><i class="fa fa-edit"></i> Add Income Item</a>
        </div>
        <div class="row mt-2">
                        ...
                        <form method="POST" action="{{route('income.store')}}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    <label class="control-label">Income Item Name</label>
                            ...
                            <div class="form-group col-md-4 align-self-end">
                                <button class="btn btn-success" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Add Income</button>
                            </div>
