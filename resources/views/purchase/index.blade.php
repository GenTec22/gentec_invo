    ...
    <main class="app-content">
        <div class="app-title">
            ...
            <ul class="app-breadcrumb breadcrumb side">
                ...
                <li class="breadcrumb-item active"><a href="#">Purchase Table</a></li>
            </ul>
        </div>
        <div class="">
            <a class="btn btn-primary" href="{{route('purchase.create')}}"><i class="fa fa-plus"></i> Add purchaseit</a>
        </div>
                            ...
                            <tr>
                             ...
                             <?php $i++?>
                                 <tr>
                                     ...
                                     <td>
                                         <a class="btn btn-primary btn-sm" href="{{ route('purchase.edit', $purchase->id) }}"><i class="fa fa-edit" ></i></a>
